...
export module skyr.v3.core.url_parser_context;

import skyr.v3.domain.domain;
import skyr.v3.core.schemes;
import skyr.v3.core.host;
import skyr.v3.core.url_parse_errc;
import skyr.v3.core.url_record;
import skyr.v3.core.url_parse_state;
        ...
        if (!state_override && details::is_windows_drive_letter(buffer)) {
          *validation_error |= true;
          ...
          if (url.host.value().serialize() == "localhost") {
            url.host.value() = skyr::host{skyr::empty_host{}};
          }
