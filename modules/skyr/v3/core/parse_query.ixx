...
export module skyr.v3.core.parse_query;
...
export {
  ...
  inline auto parse_query(std::string_view query, bool *validation_error)
      -> tl::expected<std::vector<query_parameter>, url_parse_errc> {
  ...
  /// \param query
  /// \return
  inline auto parse_query(std::string_view query) -> tl::expected<std::vector<query_parameter>, url_parse_errc> {
