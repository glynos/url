...
export module skyr.v3.concepts.url_concepts;
...
export {
  ...
  template <class T, class charT>
  concept is_string_container = is_basic_string<T, charT> || is_basic_string_view<T, charT> ||
      is_char_array<T, charT> || is_char_pointer<T, charT>;

  template <typename T>
  concept is_u8_convertible = is_string_container<T, char> || is_string_container<T, char8_t> ||
      is_string_container<T, wchar_t> || is_string_container<T, char16_t> || is_string_container<T, char32_t>;
  }  // namespace skyr::inline v3
}
