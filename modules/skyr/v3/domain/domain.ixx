...
export module skyr.v3.domain.domain;

import skyr.v3.unicode.code_point;
import skyr.v3.unicode.ranges.transforms.transform_u32;
import skyr.v3.unicode.ranges.transforms.transform_u8;
import skyr.v3.unicode.ranges.views.view_u8;
import skyr.v3.domain.domain_errc;
import skyr.v3.domain.idna;
import skyr.v3.domain.punycode;
...
export {
  ...
  inline auto domain_to_ascii_impl(domain_to_ascii_context &&context) -> tl::expected<void, domain_errc> {
    ...
    constexpr auto check_length = [](auto &&ctx) -> tl::expected<std::decay_t<decltype(ctx)>, domain_errc> {
  ...
  inline auto domain_to_u8(std::string_view domain_name, std::string *u8_domain,
