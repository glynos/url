...
TEST_CASE("encode_test", "[punycode]") {
  ...
  auto domain = GENERATE(
      std::make_pair(U"\x4F60\x597D\x4F60\x597D"s, "6qqa088eba"s), std::make_pair(U"\x4F60"s, "6qq"s),
      std::make_pair(U"\x597D"s, "5us"s), std::make_pair(U"\x4F60\x597D"s, "6qq79v"s),
      std::make_pair(U"\x4F60\x597D\x4F60"s, "6qqa088e"s), std::make_pair(U"\x9EDE\x770B"s, "c1yn36f"s),
      std::make_pair(U"fa\x00DF"s, "fa-hia"s), std::make_pair(U"\x2603"s, "n3h"s),
      std::make_pair(U"b\x00FC\x0063her"s, "bcher-kva"s), std::make_pair(U"\x00FC"s, "tda"s),
      std::make_pair(U"\x2318"s, "bih"s), std::make_pair(U"\x00F1"s, "ida"s), std::make_pair(U"\x2603"s, "n3h"s),
